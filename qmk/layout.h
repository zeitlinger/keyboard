...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_LEFT] = LAYOUT_split_3x5_2(
                       S(KC_ESC),              S(KC_X),              S(KC_W),             S(DEAD3), KC_NO, KC_NO,                DEAD1,                KC_NO,                KC_NO,                KC_NO,
                         ...
                         S(KC_Z),              S(KC_F),              S(KC_L),              S(KC_D), KC_NO, KC_NO,           MO(_LMODS), LM(_LMODS, MOD_LCTL), LM(_LMODS, MOD_LALT),                KC_NO,
	...
	[_RIGHT] = LAYOUT_split_3x5_2(
                           ...
                           KC_NO, LM(_RMODS, MOD_LALT), LM(_RMODS, MOD_LCTL),           MO(_RMODS), KC_NO, KC_NO,              S(KC_U),              S(KC_O),              S(KC_Y),              KC_UNDS,
	...
	[_VIM] = LAYOUT_split_3x5_2(
                           KC_NO,                KC_NO,                KC_NO,                KC_NO, KC_NO, KC_NO,                DEAD1,               KC_ESC,               KC_INS,                DEAD2,
                           KC_NO,              KC_LALT,              KC_LCTL,              KC_LSFT, KC_NO, KC_NO,                 KC_H,                 KC_J,                 KC_K,                 KC_L,
                           KC_NO,                KC_NO,                KC_NO,                KC_NO, KC_NO, KC_NO,               KC_ENT,              KC_BSPC,               KC_DEL,               KC_TAB,
                                           KC_NO,                KC_NO,               KC_SPC,                KC_NO),
	...
	[_ANUM] = LAYOUT_split_3x5_2(
                           KC_NO,                KC_NO,              A(KC_9),                KC_NO, KC_NO, KC_NO,                KC_NO,                KC_NO,                KC_NO,                KC_NO,
                         ...
                         A(KC_8),              A(KC_7),              A(KC_6),              A(KC_5), KC_NO, KC_NO,                KC_NO,                KC_NO,                KC_NO,                KC_NO,
                                           KC_NO,              A(KC_0),                KC_NO,                KC_NO),
	[_CNUM] = LAYOUT_split_3x5_2(
                           KC_NO,                KC_NO,              C(KC_9),                KC_NO, KC_NO, KC_NO,                KC_NO,                KC_NO,                KC_NO,                KC_NO,
                         ...
                         C(KC_8),              C(KC_7),              C(KC_6),              C(KC_5), KC_NO, KC_NO,                KC_NO,                KC_NO,                KC_NO,                KC_NO,
                                           KC_NO,              C(KC_0),                KC_NO,                KC_NO),
	[_MEDIA] = LAYOUT_split_3x5_2(
                           DEAD2,              KC_BRID,              KC_BRIU,                DEAD1, KC_NO, KC_NO,                KC_NO,                KC_NO,                KC_NO,                KC_NO,
