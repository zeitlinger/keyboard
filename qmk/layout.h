...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_BASE] = LAYOUT_split_3x5_2(
                          KC_ESC,                 KC_X,                 KC_W,                DEAD3, DEBUG_DUMP, QK_REBOOT,                DEAD2,              MAGIC_A,              MAGIC_B,                DEAD1,
	...
	[_LEFT] = LAYOUT_split_3x5_2(
                       S(KC_ESC),              S(KC_X),              S(KC_W),             S(DEAD3), DEBUG_DUMP, QK_REBOOT,                DEAD1,                KC_NO,                KC_NO,                KC_NO,
	...
	[_RIGHT] = LAYOUT_split_3x5_2(
                           KC_NO,                KC_NO,                DEAD1,                KC_NO, DEBUG_DUMP, QK_REBOOT,                DEAD3,              KC_DQUO,                 KC_Q,             S(DEAD1),
	...
	[_LMODS] = LAYOUT_split_3x5_2(
                           DEAD2,                 KC_X,                 KC_W,                DEAD3, DEBUG_DUMP, QK_REBOOT,                KC_NO,                KC_NO,                KC_NO,                KC_NO,
	...
	[_RMODS] = LAYOUT_split_3x5_2(
                           KC_NO,                KC_NO,                KC_NO,                KC_NO, DEBUG_DUMP, QK_REBOOT,                DEAD2,               KC_DOT,                 KC_Q,                DEAD1,
	...
	[_NAV] = LAYOUT_split_3x5_2(
                           DEAD3,              C(KC_X),              C(KC_V),            RCS(KC_Z), DEBUG_DUMP, QK_REBOOT,                DEAD1,               KC_ESC,               KC_INS,                DEAD2,
	...
	[_FNSYM] = LAYOUT_split_3x5_2(
                           DEAD2,               KC_F10,                KC_F9,                DEAD2, DEBUG_DUMP, QK_REBOOT,                DEAD3,              KC_LPRN,              KC_RPRN,                DEAD1,
	...
	[_NUM] = LAYOUT_split_3x5_2(
                           DEAD1,             KC_COMMA,                 KC_9,                DEAD2, DEBUG_DUMP, QK_REBOOT,                KC_NO,                KC_NO,                KC_NO,                KC_NO,
	...
	[_ANUM] = LAYOUT_split_3x5_2(
                           KC_NO,                KC_NO,                KC_NO,                KC_NO, DEBUG_DUMP, QK_REBOOT,                KC_NO,                KC_NO,                KC_NO,                KC_NO,
	...
	[_MEDIA] = LAYOUT_split_3x5_2(
                           DEAD2,              KC_BRID,              KC_BRIU,                DEAD1, DEBUG_DUMP, QK_REBOOT,                KC_NO,                KC_NO,                KC_NO,                KC_NO,
