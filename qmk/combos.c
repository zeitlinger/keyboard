...
const uint16_t PROGMEM C_NAV_AKC_F7_combo[] = {KC_S, MO(_RIGHT), COMBO_END};
...
const uint16_t PROGMEM SUB_12_combo[] = {KC_ESC, KC_S, COMBO_END};
const uint16_t PROGMEM SUB_13_combo[] = {KC_D, KC_T, COMBO_END};
const uint16_t PROGMEM SUB_14_combo[] = {KC_W, KC_N, COMBO_END};
const uint16_t PROGMEM SUB_15_combo[] = {KC_L, KC_N, COMBO_END};
const uint16_t PROGMEM SUB_16_combo[] = {KC_F, KC_C, COMBO_END};
...
const uint16_t PROGMEM C_BASE_UMUMLAUT_S_combo[] = {MAGIC_B, MO(_RIGHT), COMBO_END};
const uint16_t PROGMEM C_BASE_UPUMLAUT_AUMLAUT_A_combo[] = {MAGIC_A, MO(_RIGHT), COMBO_END};
...
const uint16_t PROGMEM SUB_1_combo[] = {KC_W, MO(_LEFT), COMBO_END};
const uint16_t PROGMEM SUB_10_combo[] = {KC_Y, MO(_RIGHT), COMBO_END};
const uint16_t PROGMEM SUB_11_combo[] = {KC_R, MO(_RIGHT), COMBO_END};
const uint16_t PROGMEM SUB_2_combo[] = {KC_U, MO(_LEFT), COMBO_END};
const uint16_t PROGMEM SUB_3_combo[] = {KC_O, MO(_LEFT), COMBO_END};
const uint16_t PROGMEM SUB_4_combo[] = {KC_A, MO(_RIGHT), COMBO_END};
const uint16_t PROGMEM SUB_5_combo[] = {KC_E, MO(_RIGHT), COMBO_END};
const uint16_t PROGMEM SUB_6_combo[] = {KC_I, MO(_RIGHT), COMBO_END};
const uint16_t PROGMEM SUB_7_combo[] = {KC_H, MO(_RIGHT), COMBO_END};
const uint16_t PROGMEM SUB_8_combo[] = {KC_U, MO(_RIGHT), COMBO_END};
const uint16_t PROGMEM SUB_9_combo[] = {KC_O, MO(_RIGHT), COMBO_END};
...
combo_t key_combos[] = {
    ...
    [C_NAV_AKC_F7] = COMBO(C_NAV_AKC_F7_combo, A(KC_F7)),
    ...
    [SUB_16] = COMBO_ACTION(SUB_16_combo),
...
uint16_t get_combo_term(uint16_t combo_index, combo_t *combo) {
    ...
    if (combo_index >= 63 && combo_index <= 105) return 125;
    return COMBO_TERM;
}
...
bool combo_should_trigger(uint16_t combo_index, combo_t *combo, uint16_t keycode, keyrecord_t *record) {
    ...
    if (combo_index == 95) return active_layer == _BASE || active_layer == _LEFT;
    if (combo_index >= 96 && combo_index <= 97) return active_layer == _BASE || active_layer == _RIGHT;
    if (combo_index >= 98 && combo_index <= 99) return active_layer == _BASE || active_layer == _LEFT;
    if (combo_index >= 100 && combo_index <= 105) return active_layer == _BASE || active_layer == _RIGHT;
    return true;
}
...
void process_combo_event(uint16_t combo_index, bool pressed) {
    ...
    case SUB_15:
        magic_decode_send(828); clear_last_keycode(); break; // "zeitlinger@gmail.com"
    case SUB_16:
        magic_decode_send(346); clear_last_keycode(); break; // "gregor@zeitlinger.de"
    case SUB_1:
        magic_decode_send(807); clear_last_keycode(); break; // "wl"
    case SUB_10:
        magic_decode_send(825); clear_last_keycode(); break; // "yr"
    case SUB_11:
        magic_decode_send(638); clear_last_keycode(); break; // "qu"
    case SUB_2:
        magic_decode_send(750); clear_last_keycode(); break; // "uh"
    case SUB_3:
        magic_decode_send(561); clear_last_keycode(); break; // "oe"
    case SUB_4:
    ...
    case SUB_7:
        magic_decode_send(379); clear_last_keycode(); break; // "hy"
    case SUB_8:
        magic_decode_send(228); clear_last_keycode(); break; // "eu"
    case SUB_9:
        magic_decode_send(571); clear_last_keycode(); break; // "oh"
