...
static const positional_combo_t positional_combos[] = {
    {C_BASE_ING, 0, 4, 1, 4, _BASE, false, 200},
    {C_BASE_KC_B, 1, 1, 2, 1, _BASE, true, 200},
    {C_BASE_KC_G, 2, 2, 1, 2, _BASE, true, 200},
    {C_BASE_KC_K, 2, 3, 1, 3, _BASE, true, 200},
    {C_BASE_KC_M, 1, 2, 0, 2, _BASE, true, 200},
    {C_BASE_KC_P, 1, 1, 0, 1, _BASE, true, 200},
    {C_BASE_KC_V, 0, 3, 1, 3, _BASE, true, 200},
    {C_BASE_MAGIC_C, 0, 0, 1, 0, _BASE, false, 200},
    {C_BASE_MAGIC_D, 1, 5, 0, 5, _BASE, false, 200},
    {C_BASE_MAGIC_E, 1, 6, 0, 6, _BASE, false, 200},
    {C_BASE_MAGIC_F, 0, 7, 1, 7, _BASE, false, 200},
    {C_BASE_MAGIC_G, 1, 0, 2, 0, _BASE, false, 200},
    {C_BASE_MAGIC_H, 1, 4, 2, 4, _BASE, false, 200},
    {C_BASE_MAGIC_I, 1, 5, 2, 5, _BASE, false, 200},
    {C_BASE_MAGIC_J, 1, 6, 2, 6, _BASE, false, 200},
    {C_BASE_MAGIC_K, 1, 7, 2, 7, _BASE, false, 200},
    {C_FNSYM_KC_AMPR, 1, 1, 2, 1, _FNSYM, false, 200},
    {C_FNSYM_KC_ASTR, 1, 2, 0, 2, _FNSYM, false, 200},
    {C_FNSYM_KC_BACKSLASH, 0, 7, 1, 7, _FNSYM, false, 200},
    {C_FNSYM_KC_CIRC, 0, 0, 1, 0, _FNSYM, false, 200},
    {C_FNSYM_KC_DLR, 1, 0, 2, 0, _FNSYM, false, 200},
    {C_FNSYM_KC_F11, 1, 2, 2, 2, _FNSYM, false, 200},
    {C_FNSYM_KC_HASH, 1, 6, 2, 6, _FNSYM, false, 200},
    {C_FNSYM_KC_KP_MINUS, 0, 3, 1, 3, _FNSYM, false, 200},
    {C_FNSYM_KC_KP_PLUS, 1, 3, 2, 3, _FNSYM, false, 200},
    {C_FNSYM_KC_LABK, 1, 5, 0, 5, _FNSYM, false, 200},
    {C_FNSYM_KC_LCBR, 2, 5, 3, 5, _FNSYM, false, 200},
    {C_FNSYM_KC_LGUI, 0, 4, 1, 4, _FNSYM, false, 200},
    {C_FNSYM_KC_LPRN, 0, 5, 3, 5, _FNSYM, false, 200},
    {C_FNSYM_KC_MINUS, 2, 4, 3, 5, _FNSYM, false, 200},
    {C_FNSYM_KC_PERC, 1, 7, 2, 7, _FNSYM, false, 200},
    {C_FNSYM_KC_PIPE, 0, 1, 1, 1, _FNSYM, false, 200},
    {C_FNSYM_KC_RABK, 1, 6, 0, 6, _FNSYM, false, 200},
    {C_FNSYM_KC_RCBR, 2, 6, 3, 5, _FNSYM, false, 200},
    {C_FNSYM_KC_RPRN, 0, 6, 3, 5, _FNSYM, false, 200},
    {C_FNSYM_KC_SLASH, 2, 5, 1, 5, _FNSYM, false, 200},
    {C_FNSYM_KC_TILD, 1, 4, 2, 4, _FNSYM, false, 200},
    {C_FNSYM_LT_NUM2KC_EQUAL, 1, 7, 3, 5, _FNSYM, false, 200},
    {C_FNSYM_MO_NUM, 3, 5, 2, 7, _FNSYM, false, 200},
    {C_LEFT_KC_COLN, 2, 0, 1, 0, _LEFT, false, 200},
    {C_NAV_AKC_F12, 1, 5, 1, 6, _NAV, false, 200},
    {C_NAV_CKC_A, 0, 2, 1, 2, _NAV, false, 200},
    {C_NAV_CKC_B, 1, 4, 1, 6, _NAV, false, 200},
    {C_NAV_CKC_C, 1, 0, 3, 2, _NAV, false, 200},
    {C_NAV_CKC_D, 1, 2, 2, 2, _NAV, false, 200},
    {C_NAV_CKC_E, 1, 0, 0, 0, _NAV, false, 200},
    {C_NAV_CKC_F12, 2, 5, 2, 4, _NAV, false, 200},
    {C_NAV_CKC_K, 2, 1, 1, 1, _NAV, false, 200},
    {C_NAV_CKC_P, 2, 6, 2, 4, _NAV, false, 200},
    {C_NAV_CKC_SLASH, 2, 5, 2, 6, _NAV, false, 200},
    {C_NAV_CKC_V, 0, 2, 3, 2, _NAV, false, 200},
    {C_NAV_CKC_W, 2, 1, 3, 2, _NAV, false, 200},
    {C_NAV_CKC_X, 0, 1, 3, 2, _NAV, false, 200},
    {C_NAV_CKC_Y, 1, 3, 2, 3, _NAV, false, 200},
    {C_NAV_CKC_Z, 3, 2, 2, 0, _NAV, false, 200},
    {C_NAV_KC_END, 1, 7, 2, 7, _NAV, false, 200},
    {C_NAV_KC_HOME, 2, 4, 1, 4, _NAV, false, 200},
    {C_NAV_KC_PGDN, 2, 5, 1, 5, _NAV, false, 200},
    {C_NAV_KC_PGUP, 2, 6, 1, 6, _NAV, false, 200},
    {C_NAV_LCAKC_B, 1, 5, 1, 4, _NAV, false, 200},
    {C_NAV_RCSKC_C, 1, 0, 2, 0, _NAV, false, 200},
    {C_NAV_RCSKC_N, 0, 1, 1, 1, _NAV, false, 200},
    {C_NAV_RCSKC_V, 1, 3, 0, 3, _NAV, false, 200},
    {C_NAV_RCSKC_Z, 0, 3, 3, 2, _NAV, false, 200},
    {C_NAV_UMUMLAUT_S, 0, 7, 1, 7, _NAV, false, 200},
    {C_NAV_UPUMLAUT_AUMLAUT_A, 0, 6, 1, 6, _NAV, false, 200},
    {C_NAV_UPUMLAUT_OUMLAUT_O, 1, 5, 0, 5, _NAV, false, 200},
    {C_NAV_UPUMLAUT_UUMLAUT_U, 0, 4, 1, 4, _NAV, false, 200},
    {C_NUM_AKC_F1, 1, 2, 0, 2, _NUM, false, 200},
    {C_NUM_CKC_G, 1, 3, 2, 3, _NUM, false, 200},
    {C_NUM_LCAKC_L, 1, 2, 2, 2, _NUM, false, 200},
    {C_NUM_LSAKC_B, 1, 1, 2, 1, _NUM, false, 200},
    {C_NUM_LSAKC_S, 1, 0, 2, 0, _NUM, false, 200},
    {C_NUM_LSAKC_X, 1, 1, 0, 1, _NUM, false, 200},
    {C_NUM_RCSKC_V, 0, 3, 1, 3, _NUM, false, 200},
    {C_RIGHT_KC_AT, 0, 4, 1, 4, _RIGHT, false, 200},
    {C_RIGHT_KC_COMMA, 1, 5, 2, 5, _RIGHT, false, 200},
    {C_RIGHT_KC_DOT, 1, 6, 2, 6, _RIGHT, false, 200},
    {C_RIGHT_KC_EXLM, 1, 2, 0, 2, _RIGHT, false, 200},
    {C_RIGHT_KC_GRAVE, 0, 7, 1, 7, _RIGHT, false, 200},
    {C_RIGHT_KC_QUES, 0, 6, 1, 6, _RIGHT, false, 200},
    {C_RIGHT_KC_QUOTE, 1, 4, 2, 4, _RIGHT, false, 200},
    {C_RIGHT_KC_UNDS, 2, 7, 1, 7, _RIGHT, false, 200},
    {C_RIGHT_N_T, 0, 5, 1, 5, _RIGHT, false, 200},
    {C_RIGHT_RCSKC_F, 1, 2, 2, 2, _RIGHT, false, 200},
    {C_RIGHT_RCSKC_R, 1, 3, 2, 3, _RIGHT, false, 200},
    {SUB_1, 0, 0, 1, 0, _LEFT, false, 200},
    {SUB_2, 2, 3, 1, 3, _MEDIA, false, 200},
    {SUB_3, 2, 2, 1, 2, _MEDIA, false, 200},
    {SUB_4, 2, 1, 1, 1, _MEDIA, false, 200},
    {SUB_5, 0, 0, 1, 0, _MEDIA, false, 200},
    {SUB_6, 1, 0, 2, 0, _MEDIA, false, 200}
};
