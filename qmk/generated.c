...
static const uint8_t chord_data[] = {
    ...
    0x0d, 0x06, 0x30, 0x89, 0x60, 0x0f, 0x07, 0x04, 0x50, 0x03, 0xe0, 0x01, 0x05, 0x30, 0x01, 0x02,
    0x00, 0x07, 0xd0, 0x84, 0x54, 0x54, 0x00, 0x05, 0x90, 0x94, 0xc1, 0x00, 0x06, 0xd0, 0x8c, 0x56,
    0x20, 0x05, 0x30, 0x99, 0x95, 0x00, 0x04, 0x50, 0xa0, 0x0a, 0x05, 0xb0, 0x28, 0xd4, 0x00, 0x0a,
    ...
    ,
    ...
    0xcd, 0xb4, 0x61, 0x03, 0x06, 0xaf, 0x20, 0xb3, 0x1c, 0x05, 0xab, 0x50, 0x40, 0x00, 0x06, 0x4b,
...
int chord_transition(int state, uint16_t keycode) {
    switch (state) {
                ...
                case -168:
                    ...
                    if (keycode == KC_J) return 39;
                    if (keycode == KC_O) return 33;
                    if (keycode == KC_R) return 28;
                    if (keycode == KC_S) return 22;
                    if (keycode == KC_T) return 17;
                ...
                case -148:
                    ...
                    if (keycode == KC_E) return 138;
                    if (keycode == KC_G) return 132;
                    if (keycode == KC_H) return 127;
                    if (keycode == KC_J) return 121;
                    if (keycode == KC_N) return 116;
                    if (keycode == KC_O) return 110;
                    if (keycode == KC_S) return 105;
                    if (keycode == KC_U) return 100;
                    if (keycode == KC_W) return 95;
                ...
                case -133:
                    ...
                    if (keycode == KC_I) return 215;
                    if (keycode == KC_L) return 209;
                    if (keycode == KC_M) return 202;
                    if (keycode == KC_N) return 197;
                    if (keycode == KC_O) return 192;
                    if (keycode == KC_P) return 186;
                    if (keycode == KC_R) return 180;
                    if (keycode == KC_T) return 175;
                    if (keycode == KC_U) return 169;
                ...
                case -117:
                    ...
                    if (keycode == KC_I) return 296;
                    if (keycode == KC_J) return 291;
                    if (keycode == KC_L) return 286;
                    if (keycode == KC_M) return 280;
                    if (keycode == KC_N) return 274;
                    if (keycode == KC_O) return 269;
                    if (keycode == KC_P) return 264;
                    if (keycode == KC_S) return 258;
                    if (keycode == KC_V) return 252;
                    if (keycode == KC_W) return 247;
                ...
                case -104:
                    ...
                    if (keycode == KC_L) return 359;
                    if (keycode == KC_N) return 354;
                    if (keycode == KC_O) return 348;
                    if (keycode == KC_R) return 343;
                    if (keycode == KC_S) return 338;
                    if (keycode == KC_T) return 333;
                    if (keycode == KC_U) return 328;
                ...
                case -89:
                    ...
                    if (keycode == KC_E) return 439;
                    if (keycode == KC_H) return 433;
                    if (keycode == KC_I) return 425;
                    if (keycode == KC_J) return 419;
                    if (keycode == KC_O) return 413;
                    if (keycode == KC_P) return 408;
                    if (keycode == KC_S) return 403;
                    if (keycode == KC_T) return 397;
                    if (keycode == KC_U) return 392;
                ...
                case -79:
                    ...
                    if (keycode == KC_S) return 482;
                    if (keycode == KC_T) return 477;
                ...
                case -66:
                    ...
                    if (keycode == KC_H) return 547;
                    if (keycode == KC_I) return 542;
                    if (keycode == KC_K) return 538;
                    if (keycode == KC_O) return 533;
                    if (keycode == KC_S) return 528;
                    if (keycode == KC_T) return 523;
                    if (keycode == KC_U) return 518;
                ...
                case -52:
                    ...
                    if (keycode == KC_H) return 612;
                    if (keycode == KC_J) return 606;
                    if (keycode == KC_O) return 601;
                    if (keycode == KC_R) return 596;
                ...
                case -40:
                    ...
                    if (keycode == KC_L) return 672;
                    if (keycode == KC_N) return 666;
                    if (keycode == KC_O) return 658;
                    if (keycode == KC_R) return 637;
                    if (keycode == KC_S) return 653;
                    if (keycode == KC_T) return 648;
                ...
                case -16:
                    ...
                    if (keycode == KC_H) return 786;
                    if (keycode == KC_I) return 781;
                    if (keycode == KC_L) return 776;
                    if (keycode == KC_N) return 771;
                    if (keycode == KC_O) return 765;
                    if (keycode == KC_R) return 760;
                    if (keycode == KC_S) return 755;
                    if (keycode == KC_T) return 750;
                    if (keycode == KC_V) return 745;
                    if (keycode == KC_Y) return 740;
                    break;
                // b
                case -2:
                    if (keycode == KC_SPC) return 883;
