...
int chord_transition(int state, uint16_t keycode) {
    switch (state) {
                ...
                case -65:
                    ...
                    if (keycode == KC_Q) return 523;
                    if (keycode == KC_T) return 518;
                    if (keycode == KC_Y) return 513;
                    if (keycode == KC_Z) return 533;
                    break;
                // k
                case -62:
