...
uint16_t get_combo_term(uint16_t index, combo_t *combo) {
    switch(index) {
    case C_BASE_CH: return 1;
    case C_BASE_GH: return 1;
    case C_BASE_ING: return 1;
    case C_BASE_KC_B: return 1;
    case C_BASE_KC_COMMA: return 1;
    case C_BASE_KC_DOT: return 1;
    case C_BASE_KC_G: return 1;
    case C_BASE_KC_J: return 1;
    case C_BASE_KC_K: return 1;
    case C_BASE_KC_Q: return 1;
    case C_BASE_KC_QUOTE: return 1;
    case C_BASE_KC_V: return 1;
    case C_BASE_KC_W: return 1;
    case C_BASE_KC_X: return 1;
    case C_BASE_KC_Z: return 1;
    case C_BASE_PH: return 1;
    case C_BASE_QK_ALT_REPEAT_KEY: return 1;
    case C_BASE_QU: return 1;
    case C_BASE_SH: return 1;
    case C_BASE_TH: return 1;
    case C_BASE_WH: return 1;
    case C_FN_CAMEL_CASE: return 500;
    case C_FN_CAPS_WORDS: return 500;
    case C_FN_DOT_CASE: return 500;
    case C_FN_KC_AMPR: return 500;
    case C_FN_KC_ASTR: return 500;
    case C_FN_KC_BACKSLASH: return 500;
    case C_FN_KC_CAPS: return 500;
    case C_FN_KC_CIRC: return 500;
    case C_FN_KC_DLR: return 500;
    case C_FN_KC_EQUAL: return 500;
    case C_FN_KC_F10: return 500;
    case C_FN_KC_F12: return 500;
    case C_FN_KC_F1: return 500;
    case C_FN_KC_F2: return 500;
    case C_FN_KC_F3: return 500;
    case C_FN_KC_F4: return 500;
    case C_FN_KC_F5: return 500;
    case C_FN_KC_F6: return 500;
    case C_FN_KC_F7: return 500;
    case C_FN_KC_F9: return 500;
    case C_FN_KC_HASH: return 500;
    case C_FN_KC_LABK: return 500;
    case C_FN_KC_LCBR: return 500;
    case C_FN_KC_LEFT_BRACKET: return 500;
    case C_FN_KC_LGUI: return 500;
    ...
    case C_FN_KEBAP_CASE: return 500;
    case C_FN_LT_NUMKC_SEMICOLON: return 500;
    case C_FN_PASCAL_CASE: return 500;
    case C_FN_SCREAMING_SNAKE_CASE: return 500;
    case C_FN_SLASH_CASE: return 500;
    case C_FN_SNAKE_CASE: return 500;
    case C_LEFT_CH: return 500;
    case C_LEFT_GH: return 500;
    case C_LEFT_PH: return 500;
    case C_LEFT_QU: return 500;
    case C_LEFT_SH: return 500;
    case C_LEFT_TH: return 500;
    case C_LEFT_WH: return 500;
    ...
    case C_NAV_KC_BSPC: return 500;
    case C_NAV_KC_DEL: return 500;
    case C_NAV_KC_DOWN: return 500;
    case C_NAV_KC_ENT: return 500;
    case C_NAV_KC_ESC: return 500;
    case C_NAV_KC_INS: return 500;
    case C_NAV_KC_LEFT: return 500;
    case C_NAV_KC_MUTE: return 500;
    case C_NAV_KC_RIGHT: return 500;
    case C_NAV_KC_SPC: return 500;
    case C_NAV_KC_TAB: return 500;
    case C_NAV_KC_UP: return 500;
    ...
    if (record->tap.count) {
        ...
        if (record->event.pressed) {
            if (get_repeat_key_count() > 0) {
                ...
                case KC_H: tap_code16(KC_I); return false;
                ...
                case S(KC_H): tap_code16(KC_I); return false;
