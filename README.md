...
|     Base      |    b    |    c    |    g    |    d    |    p    | *Leader |   rep   |  aRep   |
|               | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- |
|     Base      |         |         |   💎    |    z    |         |         |         |         |                                       
|     Base      |         |         |         |         |         |         |         |         |
|     Base      |         |         |         |         |         |         |         |         |
...
|    Umlaut     |         |         |         |         |         |         |         |         |
|               | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- |
|    FnLeft     |         |   f6    |   f5    |   f4    |         | =Mouse  |         |         |
|    FnLeft     |   f3    |   f2    |   f1    |   f10   |         |         |         | NumLeft |
|    FnLeft     |   f11   |   f9    |   f8    |   f7    |         |         |         |  Media  |
|               | ------- | ------- | ------- | ------- | ------- | ------- | ------- | ------- |
|    NumLeft    |         |    6    |    5    |    4    |         |         |         |         |
|    NumLeft    |    3    |    2    |    1    |    0    |         |         |         |         |
|    NumLeft    |         |    9    |    8    |    7    |         |         |         |         |
...
|    Leader     |                  |                  |               |                |       |
|      Fn       |  OneShotHomeRow  |                  |               |                |       |
|    FnLeft     | HomeRow+BaseMods |  OneShotHomeRow  |               |                |       |
|     Mouse     |    BottomRow     |                  |               |                |       |
|    Mouse2     |                  |                  |               |                |       |
|    Switch     |                  |                  |               |                |       |
|    TabNav     |     HomeRow      | HomeRow+BaseMods |    Switch     |      Nav       |       |
|      Nav      |  OneShotHomeRow  |                  |               |                |       |
|     Nav2      |  OneShotHomeRow  |                  |               |                |       |
|    NumLeft    |                  |     HomeRow      |               |                |       |
|   BaseMods    |     HomeRow      |     HomeRow      |     Base      |      Base      |       |
| BaseModsLeft  |                  |     HomeRow      |     Base      |                |       |
| BaseModsRight |     HomeRow      |                  |               |      Base      |       |
|    ParNum     |     HomeRow      |                  |               |                |       |
|    CurBra     |     HomeRow      |                  |               |                |       |
|     Media     |                  |                  |               |                |       |
|     Debug     |                  |                  |               |                |       |
...
| un      | C(KC_Z)                                        |
| S-paste | RCS(KC_V)                                      |
| 💡paste | custom:INTELLIJ_PASTE LayerHint:NumLeft        |
| cut     | C(KC_X)                                        |
| copy    | C(KC_C)                                        |
| paste   | C(KC_V)                                        |
| ä       | ALGR(KC_Q)                                     |
...
| l-l-alt | custom:LEADER_LEFT_ALT LayerHint:BaseModsRight |
| l-l-ctl | custom:LEADER_LEFT_CTL LayerHint:BaseModsRight |
| l-l-sft | custom:LEADER_LEFT_SFT LayerHint:BaseModsRight |
