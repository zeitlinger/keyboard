...
private val SKIP_LAYERS = setOf("LMods", "RMods", "LLit", "RLit", "ANum", "CNum", "Case", "Vim")
...
fun writeKeymapDrawerYaml(
    ...
    // two pseudo-layer blocks — one per shift key (left-pinky, right-pinky) — mirroring the
    // README's extra 4-row blocks. Each pseudo-layer shows the combo output at each partner key's
    // position, and highlights the shift key with a ⇧ badge.
    val directionals =
